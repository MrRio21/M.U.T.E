...
<div class="container" style="margin:10rem">
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="package-item bg-white mb-2">
                ...
                <img src="{{url('http://localhost:8000/storage/imgs/'.$room->cover_img)}}" alt="" style="height: 16rem; width:23rem">
    ...
    <button class="btn btn-success" type="submit" style="margin-left:30rem ">continue My Trip</button>
</div>
...
<div style="margin-left:10rem;text-align:center ">
    ...
    {{-- <button type="submit" class="btn btn-success " style="margin-left:40rem " >Book Now & next step </button> --}}
</form>
