...
<head>
    ...
    <link rel="stylesheet" href="{{asset('./assets/pay.css')}}" class="href">
    <link rel="stylesheet" href="{{asset('https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css')}}" class="src" >
    <link rel="stylesheet" href="{{asset('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.0.3/css/font-awesome.css')}}" class="src">
                                ...
                                <div class="row">
                                    <div class="col-md-12 red-bg">
                                        ...
                                        <h2 class="bill-head" id="total">
                                            2004 EGP
                                            {{-- {{dd($totalPaidInRooms)}} --}}
                                         {{-- {{    (int)$totalPaidInRooms[0] +  (int)$totalPaidInTourguide[0] + (int)$totalPaidInPlaces[0]}} --}}
                                        </h2>
