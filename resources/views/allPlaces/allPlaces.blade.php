...
<form action="{{route('storeRegPlace.store')}}" method="POST">
    @csrf
    <!-- Carousel Start -->
                          ...
                          <div class="col-md-3">
                              <div class="mb-3 mb-md-0">
                                  <div class="date" id="date1" data-target-input="nearest">
                                      <input type="date" class="form-control p-4 datetimepicker-input" placeholder="Depart Date" name="check_in" data-target="#date1" data-toggle="datetimepicker"/>
                                  </div>
                              </div>
                          </div>
                          <div class="col-md-3">
                              <div class="mb-3 mb-md-0">
                                  <div class="date" id="date2" data-target-input="nearest">
                                      <input type="date" class="form-control p-4 datetimepicker-input" placeholder="Return Date" name="check_out" data-target="#date2" data-toggle="datetimepicker"/>
                                  </div>
                              </div>
                          </div>
          ...
          <div class="package-item bg-white mb-2" >
            ...
            >
              <div class="p-4">
                  ...
                  <p class="h6 text-decoration-none" style="height: 6rem">{{$Place->description}}</p>
